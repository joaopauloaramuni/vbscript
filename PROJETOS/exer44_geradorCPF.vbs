...
'Inicializa o gerador para que novos valores sejam sorteados a cada execução do script
Randomize   
'Inicializa o teste da validação do cpf como falso
validacao = false

'Sorteia um cpf até que o mesmo seja válido
do
	cpf = Int( 99999999999 * Rnd + 1 )
	validacao = ValidateCPF(cpf)
loop while validacao = false

'Exibe o cpf válido
msgbox "CPF Gerado: " & cpf
